package com.gzhennaxia.questionbank.common.pojo.vo;

import com.gzhennaxia.questionbank.common.enums.ResponseCode;
...
public class ApiResult<T> {
    ...
    public static <T> ApiResult<T> error(String message) {
        return new ApiResult<>(ResponseCode.INTERNAL_ERROR.getCode(), message, null);
    }
