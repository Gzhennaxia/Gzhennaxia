...
```shell
curl --location 'https://localhost:5000/v1/api/portfolio/U16166218/allocation' \
...
```shell
curl --location 'https://localhost:5000/v1/api/portfolio/U16166218/positions/0' \
